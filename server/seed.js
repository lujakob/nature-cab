  ...
  USER.find((err, users) => {
    if(err) {
      ...
      const rideList = [
        ...
        {userId: 2, start: 'Munich', end: 'Tegernsee', seats: 2, price: 28, activity: ACTIVITIES.HIKE, id: 2, startDate: moment().startOf('hour').toDate(), user: users[1]._id},
        {userId: 1, start: 'Augsburg', end: 'Spitzingsee', seats: 2, price: 28, activity: ACTIVITIES.TRAILRUN, id: 3, startDate: moment().add(4, 'days').startOf('hour').toDate(), user: users[0]._id},
