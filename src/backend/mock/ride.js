...
export const rides = [
  ...
  {startLocation: 'München Hauptbahnhof, München, Deutschland', startLatLng:
    ...
    [47.4916945, 11.095498399999997], endCity: 'Garmisch-Partenkirchen', seats: 2, price: 28, vehicle: 'TRAIN', activity: ACTIVITIES[2]['id'], id: 3, startDate: moment().add(4, 'days').startOf('hour').toDate(), returnInfo: '17 Uhr', user: 0, description: 'Wir können gerne zusammen laufen gehen. Ich denke Tempo mittel, 2h hoch und 1h runter.'},
  {startLocation: 'München Hauptbahnhof, München, Deutschland', startLatLng:
