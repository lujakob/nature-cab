...
export const rides = [
  ...
  {startLocation: 'Bahnhofstrasse Augsburg, Deutschland', startLatLng:
    ...
    [47.71315240000001, 11.758015999999998], endCity: 'Tegernsee', seats: 2, price: 28, vehicle: 'CAR', activity: ACTIVITIES[1]['id'], id: 2, startDate: moment().startOf('hour').toDate(), user: 1, returnInfo: 'Ich würde gerne um 16 Uhr am Parkplatz zurück sein und dann gemütlich heimfahren.'},
  {startLocation: 'München Hauptbahnhof, München, Deutschland', startLatLng:
    [48.1412956, 11.559116399999994], startCity: 'München', endLocation: 'Garmisch-Partenkirchen, Deutschland', endLatLng:
    [47.4916945, 11.095498399999997], endCity: 'Garmisch-Partenkirchen', seats: 2, price: 28, vehicle: 'TRAIN', activity: ACTIVITIES[2]['id'], id: 3, startDate: moment().add(4, 'days').startOf('hour').toDate(), user: 0, returnInfo: 'Wir können gerne zusammen laufen gehen. Ich denke Tempo mittel, 2h hoch und 1h runter.'},
  {startLocation: 'München Hauptbahnhof, München, Deutschland', startLatLng:
